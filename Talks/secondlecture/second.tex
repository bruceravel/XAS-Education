...
\begin{frame}
  ...
  \begin{block}{This fall$^\ast$, just at my beamline NSLS X23A2, my users include}
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.60\linewidth}
      Here are 42 scans taken over the course of 22 hours at APS BM20
      (one of my favorite XAS beamlines in North America) on a sample
      with 3\,mM Hg bound to an engineered DNA complex.
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.6\linewidth}
      ...
      \begin{center}
        \includegraphics[width=0.8\linewidth]{images/xrfxas.png}
      \end{center}
    \end{column}
  \end{columns}
