...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \end{column}
    \begin{column}{0.5\linewidth}
      \includegraphics[width=0.75\linewidth]{dummy.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  quantities, very little is taken up by the plants growing the that
  soil.
...
%\include{200nm}    % deinococus radiodurans example
