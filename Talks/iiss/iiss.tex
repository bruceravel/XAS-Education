...
\title{Introduction to Inner Shell Spectroscopies}
...
\date[S$_4$III]{Saskatoon Synchrotron Summer School III\\August 18--22, 2008}

\logo{\includegraphics[width=1.0cm]{images/ankaxas.jpg}}
...
\begin{frame}
  ...
  \begin{center}
    NIST X-ray Fluorescence Standard \#1833\\
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.8\linewidth]{exp/bl.pdf}
...
\end{frame}
\begin{frame}
  \frametitle{The HXMA Beamline: A Fine Example}
  \begin{center}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.8\linewidth]{images/periodic_table_of_elements.png}
...
\begin{frame}
  ...
  but a few examples from my recent work.
...
\begin{frame}
  ...
  \begin{center}
    ...
    \only<1| handout:1>{\includegraphics[width=0.8\linewidth]{xrf/pebble.png}}
    \only<2| handout:2>{\includegraphics[width=0.8\linewidth]{xrf/pebblespot.png}}
  \end{center}

  \begin{textblock*}{0.5\linewidth}(0pt,20\TPVertModule)
    \tiny D. Phillips et el., Env. Sci. and Tech., in press.
  \end{textblock*}
\end{frame}
\begin{frame}
...
\begin{frame}
  ...
  \begin{columns}[T]
    \begin{column}{0.6\linewidth}
      \qquad\includegraphics[width=0.7\linewidth]{xrf/arabadopsis_sm.png}

      \quad\includegraphics[width=0.8\linewidth]{xrf/arabadopsis_xanes.png}
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.4\linewidth}
      \begin{center}
        \includegraphics[width=0.9\linewidth]{xrf/dr_tem_grid.jpg}\\[1ex]
        {\tiny
          \begin{tabular}{ccc}
