...
%\date[Sheffield]{University of Sheffield\\18 October 2010}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.7\linewidth]{exp/bl.pdf}
...
\begin{frame}
  ...
  \includegraphics[width=0.85\linewidth]{JM/figure6.pdf}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \only<1| handout:1>{\includegraphics[width=0.7\linewidth]{xrf/pebble.png}}
    \only<2| handout:2>{\includegraphics[width=0.7\linewidth]{xrf/pebblespot.png}}
  \end{center}
