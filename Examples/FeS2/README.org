...
The file ~FeS2.fpj~ is an Artemis project file containing the final
fitting model that I show when presenting this fit during an XAS
workshop.  This example is [[http://bruceravel.github.com/demeter/artug/examples/fes2.html][worked through]] in the Artemis users' Guide.
...
Diamond]].  Finally, check out [[http://cloud.github.com/downloads/bruceravel/XAS-Education/fes2.pdf][this presentation]] for discussion of the
