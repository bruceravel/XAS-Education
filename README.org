...
PDF files can be found in the [[https://github.com/bruceravel/XAS-Education/downloads][downloads area]].
...
** Other folders
 ...
 + ~sty/~
   ...
   + common copyright statement, author information, and date
